...
typedef enum {
    ...
    MPK_API_ERR_UNINITIALIZED = 0x02,
    MPK_API_ERR_HTTP = 0x03,
    MPK_API_ERR_NOTHING_READ = 0x04,
    MPK_API_ERR_JSON_PARSE = 0x05,
    MPK_API_ERR_JSON_ARRAY = 0x06,
    MPK_API_ERR_OVERFLOW = 0x07,
    MPK_API_ERR_INPUT = 0x08,
    MPK_API_ERR_CONV_TYPE = 0x09,
    MPK_API_ERR_FETCH_HEADERS = 0x0A
} mpk_api_status_t;
